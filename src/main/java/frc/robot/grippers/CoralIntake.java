...
public class CoralIntake extends SubsystemBase{
    ...
    private final SparkMax intakeMotor = new SparkMax(CoralIntakeConstants.kIntakeMotorPort, MotorType.kBrushless);
    private final SparkMax rotationMotor = new SparkMax(CoralIntakeConstants.kRotationMotorPort, MotorType.kBrushless);
