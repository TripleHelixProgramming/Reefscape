...
public class BlueNoProcess3PieceAuto extends AutoMode {
  ...
  public AutoRoutine getAutoRoutine() {
    ...
    blueNoProcess3PieceRoutine
        .active()
        .onTrue(Commands.parallel(blueNoProcessToL4I.cmd(), coralL4PositionCommand));
    ...
    blueNoProcessToL4I
        ...
        .onTrue(
            Commands.sequence(
                ...
                new ParallelCommandGroup(blueL4IToSource.cmd(), coralIntakePositionCommand)));
    ...
    blueL4IToSource
        ...
        .onTrue(
            Commands.parallel(
                ...
                Commands.sequence(
                    new WaitCommand(0.2),
                    Commands.parallel(blueSourceToL4L.cmd(), coralL4PositionCommand))));
    ...
    blueSourceToL4L
        ...
        .onTrue(
            Commands.sequence(
                ...
                new WaitCommand(0.2),
                coralIntake.createSetIntakeVelocityCommand(0),
                Commands.parallel(coralIntakePositionCommand, blueL4LToSource.cmd())));
    ...
    blueL4LToSource
        ...
        .onTrue(
            Commands.parallel(
                ...
                Commands.sequence(
                    new WaitCommand(0.2),
                    Commands.parallel(coralL4PositionCommand, blueSourceToL4K.cmd()))));
