...
public class AutoCGs {
  ...
  public ParallelCommandGroup coralL4PositionCommand() {
    return new ParallelCommandGroup(
        ...
        algaeWrist.createSetRotationPositionCommand(AlgaeIntakeStates.CoralMode.angle));
  }
  ...
  public ParallelCommandGroup algaeBargePositionCommand() {
    return new ParallelCommandGroup(
        ...
        algaeWrist.createSetRotationPositionCommand(AlgaeIntakeStates.Barge.angle));
  }
  ...
  public ParallelCommandGroup algaeL3PositionCommand() {
    return new ParallelCommandGroup(
        ...
        coralWrist.createSetRotationPositionCommand(CoralIntakeStates.AlgaeMode.angle),
        algaeWrist.createSetRotationPositionCommand(AlgaeIntakeStates.L3.angle));
  }
  ...
  public ParallelCommandGroup algaeL2PositionCommand() {
    return new ParallelCommandGroup(
        ...
        coralWrist.createSetRotationPositionCommand(CoralIntakeStates.AlgaeMode.angle),
        algaeWrist.createSetRotationPositionCommand(AlgaeIntakeStates.L2.angle));
  }
  ...
  public ParallelCommandGroup algaeProcessorPositionCommand() {
    return new ParallelCommandGroup(
        ...
        coralWrist.createSetRotationPositionCommand(CoralIntakeStates.AlgaeMode.angle),
        algaeWrist.createSetRotationPositionCommand(AlgaeIntakeStates.Processor.angle));
  }
  ...
  public ParallelCommandGroup algaeFloorIntakePositionCommand() {
    return new ParallelCommandGroup(
        ...
        coralWrist.createSetRotationPositionCommand(CoralIntakeStates.AlgaeMode.angle),
        algaeWrist.createSetRotationPositionCommand(AlgaeIntakeStates.Floor.angle));
  }
}
