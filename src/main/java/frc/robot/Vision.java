...
public class Vision {
    ...
    public Vision() {
        camera = new PhotonCamera(CameraConstants.kCameraName1);

        photonEstimator = new PhotonPoseEstimator(CameraConstants.kTagLayout, PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, CameraConstants.kRobotToCam);
